...
def generate_ticker_est_act_buy_fundamental_details_csv():
	tickers = call_procedure("get_ticker_details_by_data_type","4")
	i = 0
	df = None
	...
	while i < len(tickers):
		ticker_sym = tickers[i][1]
		ticker_id = tickers[i][2]
		#indicator = call_procedure("get_ticker_indicator_value_details_without_target",[ticker_id])
		indicator = call_procedure("get_ticker_xm_fundamental_value_details",[ticker_id,0])
		...
		#df = pd.DataFrame(indicator, columns=["ticker_id" , "ticker_name", "ticker_symbol", "target","date","cq1_analyst_estimate_earning_per_share_high_quarterly","cq1_analyst_estimate_earning_per_share_mean_quarterly","cq1_analyst_estimate_gross_profit_margin_high_quarterly","cq1_analyst_estimate_gross_profit_margin_mean_quarterly","cq1_analyst_estimate_net_income_high_quarterly","cq1_analyst_estimate_net_income_mean_quarterly","cq1_analyst_estimate_revenue_high_quarterly","cq1_analyst_estimate_revenue_mean_quarterly","revenue_quarterly","earning_per_share_quarterly","gross_profit_margin_quarterly","net_income_quarterly","analyst_estimate_revenue_mean_quarterly","analyst_estimate_revenue_high_quarterly","company_estimate_revenue_mean_quarterly","analyst_estimate_earning_per_share_high_quarterly","analyst_estimate_earning_per_share_mean_quarterly","company_estimate_earning_per_share_mean_quarterly","analyst_estimate_gross_profit_margin_mean_quarterly","company_estimate_gross_profit_margin_mean_quarterly","analyst_estimate_gross_profit_margin_high_quarterly","analyst_estimate_net_income_high_quarterly","analyst_estimate_net_income_mean_quarterly","company_estimate_net_income_mean_quarterly","cy1_analyst_estimate_earning_per_share_high_annual","cy1_analyst_estimate_earning_per_share_mean_annual","cy1_analyst_estimate_gross_profit_margin_high_annual","cy1_analyst_estimate_gross_profit_margin_mean_annual","cy1_analyst_estimate_net_income_high_annual","cy1_analyst_estimate_net_income_mean_annual","cy1_analyst_estimate_revenue_high_annual","cy1_analyst_estimate_revenue_mean_annual","revenue_annual","earning_per_share_annual","gross_profit_margin_annual","net_income_annual","analyst_estimate_revenue_mean_annual","analyst_estimate_revenue_high_annual","company_estimate_revenue_mean_annual","analyst_estimate_earning_per_share_high_annual","analyst_estimate_earning_per_share_mean_annual","company_estimate_earning_per_share_mean_annual","analyst_estimate_gross_profit_margin_mean_annual","company_estimate_gross_profit_margin_mean_annual","analyst_estimate_gross_profit_margin_high_annual","analyst_estimate_net_income_high_annual","analyst_estimate_net_income_mean_annual","company_estimate_net_income_mean_annual"])
		df.to_csv(directory + "\\" + ticker_sym+".csv", index=False, encoding='utf-8')
		i+=1
	return directory
...
#generate_ticker_est_act_buy_fundamental_details_csv()
