...
def save_job_status(job_id,ticker_id,status, retry_count,total_process_count,success_count,failed_count,job_date,job_start_date,job_end_date):
	job_details=db.call_procedure("insert_update_fail_log_status_details",[job_id,ticker_id, status, retry_count,total_process_count,success_count,failed_count,job_date,job_start_date,job_end_date])
